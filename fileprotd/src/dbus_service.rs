...
impl AccessControlService {
    ...
    async fn verify_peer(
        ...
        // The peer process could exit and be replaced by a different binary
        // with the same PID before we open /proc/<pid>/exe.
        // However, that's fine.
        // The only real attack scenario is that:
        // 1. Attacker does a request and exits.
        // 2. A genuine GUI process starts with the same PID.
